...
Console application project and enabled the `/clr` switch. Copy the `include`, `gtestd.lib` and `tgest.lib` (Debug and Release) somewhere into your project. I usually put it in a `vendor` folder. Here is what your `main` should look like:
